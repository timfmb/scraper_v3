...
from refactor_scrapers import extract_url_extractor_multi_page_button_click_playwright, extract_data_extractor
...
for site in boatseekr_sites:
    ...
    if "from applications.url_extractor.extractor.url_scrapers.multi_page_button_click_playwright_scraper import MultiPageButtonClickPlaywrightScraper" not in scraper['url_extractor_code']:
        continue
    ...
    extracted_url_extractor = extract_url_extractor_multi_page_button_click_playwright(scraper['url_extractor_code'])
    ...
    builder.create_multi_page_button_click_playwright_config(
        ...
        button_selector=extracted_url_extractor['button_selector']
    )
