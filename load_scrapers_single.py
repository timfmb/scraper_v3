...
from refactor_scrapers import extract_url_extractor_single_page_playwright, extract_data_extractor
...
for site in boatseekr_sites:
    ...
    if "from applications.url_extractor.extractor.url_scrapers.single_page_simple_scraper import SinglePageSimpleScraper" not in scraper['url_extractor_code']:
        continue
    ...
    extracted_url_extractor = extract_url_extractor_single_page_playwright(scraper['url_extractor_code'])
    ...
    builder.create_single_page_playwright_config(
