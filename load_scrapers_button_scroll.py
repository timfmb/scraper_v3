...
from refactor_scrapers import extract_url_extractor_button_scroll_playwright, extract_data_extractor
...
for site in boatseekr_sites:
    ...
    if "from applications.url_extractor.extractor.url_scrapers.button_scroll_playwright_scraper import ButtonScrollPlaywrightScraper" not in scraper['url_extractor_code']:
        continue
    ...
    extracted_url_extractor = extract_url_extractor_button_scroll_playwright(scraper['url_extractor_code'])
    ...
    builder.create_button_scroll_playwright_config(
